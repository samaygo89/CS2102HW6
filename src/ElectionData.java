...
class ElectionData {
    private HashMap<String, BallotEntry> ballot = new HashMap<String, BallotEntry>();
    ...
    public String findWinnerMostFirstVotes() {
        double req_votes_for_win = (double) total_votes / 2;
        for (String e : ballot_names) {
            BallotEntry currBallot = ballot.get(e);
    ...
    public void processVote(String FirstVoteParam, String SecondVoteParam, String ThirdVoteParam)
        ...
        BallotEntry FirstVote = ballot.get(FirstVoteParam);
        FirstVote.addFirstVote();
        BallotEntry SecondVote = ballot.get(SecondVoteParam);
        SecondVote.addSecondVote();
        BallotEntry ThirdVote = ballot.get(ThirdVoteParam);
        ThirdVote.addThirdVote();
    }
